...
export default function Footer() {
  return (
    <div className="flex flex-col items-center w-full px-6 pb-3 bg-background z-50 dark:bg-[#111111]">
      ...
      {/* Social and credit footer */}
      <div className="w-full border-t pt-4 text-center text-muted-foreground flex flex-col items-center justify-center">
        <div className="flex flex-col md:flex-row items-center justify-center gap-y-2 w-full">
          ...
          <p className="text-sm text-gray-400 md:ml-4">
            © 2025 Built with <span className="text-red-500">❤️</span>
          </p>
        </div>
      </div>
    </div>
